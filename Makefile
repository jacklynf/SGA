...
OBJECTS    = main.o shift_register_control.o encoder.o interrupt_init.o npk.o humidity.o soil_moisture.o i2c.o light_sensor.o i2c_mux.o LCD.o LCD_GFX.o Touchscreen.o WaterLevel.o
